...
public abstract class AbsPagerStateAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (DEBUG)
//			Log.v(TAG, "Adding item #" + position + ": f=" + fragment + " TAG:"
//					+ fragment.getTag());
            // if (!isOnFManager(fragment) && !(mFragments.contains(fragment))) {
            if (!mFragments.contains(fragment)) {
                defaultInstantiateItem(container, position, fragment);
            } else {
                LooperInstantiateItem(container, position, fragment);
    ...
    /*
     * private boolean isOnFManager(int position){ return
     * (mFragmentManager.findFragmentByTag(""+position)==null); }
     */
    @Override
