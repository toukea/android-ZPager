...
public class PagerLoopStateAdapter extends ScreenStatePagerAdapter {
	List<ScreenPage> fakeItems = new ArrayList<ScreenPage>();

	public PagerLoopStateAdapter(FragmentManager fm) {
		super(fm);
	 ...
	 * 
	 * 
	 * @Override public int getIcon() { // TODO Auto-generated method stub
	 * return tmpPage.getIcon(); }
	 * 
